...
for nombre, datos in alumnos.items():
    if datos['edad'] >= 18 and datos['nota'] >=7:
        print(f"Alumno mayor de 18 y con nota mayor o igual a 7: {nombre.capitalize()}\n")
...
while True:
    ...
    if opcion == "1":
        ...
        for nombre, datos in alumnos.items():
            print(f"- {nombre.capitalize()} (Curso: {datos['curso']}, Nota: {datos['nota']})")
...
while True:
    nombre_nuevo = input("Introducte el nombre del alumno (o escribe 'salir' para cancelar): ").lower()
